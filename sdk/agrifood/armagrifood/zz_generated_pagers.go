...
type ExtensionListResponsePager interface {
	...
	// PageResponse returns the current ExtensionListResponseResponse.
...
type FarmBeatsExtensionListResponsePager interface {
	...
	// PageResponse returns the current FarmBeatsExtensionListResponseResponse.
...
type FarmBeatsListResponsePager interface {
	...
	// PageResponse returns the current FarmBeatsListResponseResponse.
